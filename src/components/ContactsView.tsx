            ...
            <div className="space-y-2.5">
              ...
              {contact.roleOrSpecialty && (
                <div className="text-xs bg-zinc-50 p-2 rounded-sm border border-zinc-200 text-zinc-700">
                  <span className="font-semibold text-zinc-900">{contact.roleOrSpecialty}</span>
                  {contact.hourlyRate && (
                    <span className="text-zinc-500 ml-2 font-mono">(${contact.hourlyRate}/hr)</span>
                  )}
                  {contact.rating && (
              ...
              {contact.propertyName && (
                <div className="text-xs text-zinc-600">
                  <p><strong className="text-zinc-800">{contact.propertyName}</strong></p>
                  {contact.roomName && <p className="text-zinc-600 font-medium text-[11px] ml-4">{contact.roomName}</p>}
                </div>
              )}
