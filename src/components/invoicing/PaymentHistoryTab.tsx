...
export const PaymentHistoryTab: React.FC<PaymentHistoryTabProps> = ({
  ...
  const handleSeedDemoPayments = () => {
    ...
    const yankProp = properties.find(p => p.id === 'prop-1070-yank' || p.name?.includes('1070 Yank')) || properties[0] || { id: 'prop-1070-yank', name: '1070 Yank St', squareLocationId: 'LN4WBHANNNZ2Y' };
    ...
    const demoInvoices: Invoice[] = [
      {
        ...
        squareOrderId: 'ord_yank_001',
        squareLocationId: yankProp.squareLocationId || 'LN4WBHANNNZ2Y',
        propertyId: yankProp.id,
        propertyName: yankProp.name,
        roomName: 'Room 1 - Front South Upper',
      ...
      },
      {
        ...
        squareOrderId: 'ord_yank_002',
        squareLocationId: yankProp.squareLocationId || 'LN4WBHANNNZ2Y',
        propertyId: yankProp.id,
        propertyName: yankProp.name,
        roomName: 'Room 2 - Middle East Upper',
      ...
      },
      {
        ...
        squareOrderId: 'ord_yank_004',
        squareLocationId: yankProp.squareLocationId || 'LN4WBHANNNZ2Y',
        propertyId: yankProp.id,
        propertyName: yankProp.name,
        roomName: 'Room 3 - Southeast Upper',
      ...
      },
      {
        ...
        squareOrderId: 'ord_yank_005',
        squareLocationId: yankProp.squareLocationId || 'LN4WBHANNNZ2Y',
        propertyId: yankProp.id,
        propertyName: yankProp.name,
        roomName: 'Room 4 - West Upper',
