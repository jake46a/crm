    ...
    <div className="fixed inset-0 bg-slate-900/70 backdrop-blur-xs flex items-center justify-center p-4 z-50 overflow-y-auto">
      <div className="bg-white rounded-2xl max-w-lg w-full shadow-2xl border border-slate-200 overflow-hidden my-8 animate-in fade-in zoom-in duration-150">
        <div className="bg-slate-900 text-white p-5 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Configure address, amenities, lock codes, and owner details</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-3.5 text-xs max-h-[720px] overflow-y-auto">
          <div>
            <label className="block font-bold text-slate-700 mb-1">Property Name / Nickname *</label>
            <input
              type="text"
              required
              ...
              className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 font-medium text-slate-800"
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-lg text-slate-800 focus:ring-2 focus:ring-blue-500"
            />
          </div>
          ...
          <div className="grid grid-cols-6 gap-2.5">
            ...
            <div className="col-span-1">
              ...
              <input
                ...
                className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-lg text-slate-800 uppercase text-center font-mono focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div className="col-span-2">
              ...
              <input
                ...
                className="w-full p-2.5 bg-slate-50 border border-slate-300 rounded-lg text-slate-800 font-mono focus:ring-2 focus:ring-blue-500"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            ...
            <div>
              <label className="block font-bold text-slate-700 mb-1">Year Built</label>
              <input
                type="number"
                value={yearBuilt}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
            <div>
              <label className="block font-bold text-slate-700 mb-1">Wi-Fi Network Name</label>
              <input
                type="text"
                value={wifiNetwork}
            ...
            <div>
              <label className="block font-bold text-slate-700 mb-1">Keypad Door Master Code</label>
              <input
                type="text"
          ...
          <div>
            <label className="block font-bold text-slate-700 mb-1">Shared Amenities (comma separated)</label>
            <input
              type="text"
          ...
          <div>
            <label className="block font-bold text-slate-700 mb-1">House Rules (comma separated)</label>
            <textarea
              rows={2}
              value={houseRules}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2.5 pt-4 border-t border-slate-200">
